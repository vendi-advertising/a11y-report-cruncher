 ...
 */
final class Version20190208211626 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE scan_batch_url (id INT AUTO_INCREMENT NOT NULL, scan_batch_id_id INT NOT NULL, property_scan_url_id_id INT NOT NULL, INDEX IDX_C44E265ADB2FBA34 (scan_batch_id_id), INDEX IDX_C44E265A87EB27DF (property_scan_url_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE scan_batch ADD date_time_created DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE scan_batch DROP date_time_created');
        $this->addSql('ALTER TABLE scanner CHANGE date_time_created date_time_created DATETIME DEFAULT \'current_timestamp()\' NOT NULL');
        $this->addSql('ALTER TABLE scanner_type CHANGE date_time_created date_time_created DATETIME DEFAULT \'current_timestamp()\' NOT NULL');
