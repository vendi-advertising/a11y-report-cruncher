 ...
 */
final class Version20190216123706 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE accessibility_check (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, impact VARCHAR(255) NOT NULL, message VARCHAR(1024) NOT NULL, date_time_created DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
