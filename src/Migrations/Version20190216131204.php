 ...
 */
final class Version20190216131204 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE accessibility_check DROP impact, DROP message');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE accessibility_check ADD impact VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, ADD message VARCHAR(1024) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
